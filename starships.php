    ...
    <body>
        ...
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="./starships.php">Naves</a></li>
                ...
                <table class="table">
                    ...
                    <?php
                        foreach($resultado->results as $filme){
                            ...
                            echo "<td>".$filme->hyperdrive_rating."</td>";
                            echo "<td>".$filme->MGLT."</td>";
                            echo "<td>".$filme->starship_class."</td>";
                            echo "</tr>";
                        }
                    ?>
                </table>
