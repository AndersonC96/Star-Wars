<html>
    ...
    <body>
        ...
        <section class="intro">Há muito tempo, em uma galáxia muito,<br> muito distante…</section>
        <section class="logo">
